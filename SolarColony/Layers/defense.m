...
- (instancetype)init
{
    ...
    for (int i=0; i<5; i++) {
        ...
        // register soldiers at cllision manager
        //CGPoint locationSoldier=[temp getPOSITION];
       // [colissionsManager addSoldierTest:locationSoldier] ;
        [colissionsManager addSoldierTestB:temp] ;
    }
