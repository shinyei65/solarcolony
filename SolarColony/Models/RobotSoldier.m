    ...
    switch (direction) {
        ...
        case 'L':{
            if (currentDirection == 'R')
                [_soldier setTexture:[[CCSprite spriteWithFile:@"RobotSoldier_Special_left.png"]texture]];
        ...
        case 'R':{
            if (currentDirection == 'L')
                [_soldier setTexture:[[CCSprite spriteWithFile:@"RobotSoldier_Special.png"]texture]];
